...
/** Chapter-number count-up entrance (00 → target, 400ms) */
...
/** Chapter heading: leading JetBrains Mono chapter number (chapter color) + h2 */
...
/** Sub-section heading (h3, e.g. 2.1 ReAct) */
...
/** "In plain terms" paragraph: cyan chip + body-lg paragraph (fade-up 500ms) */
...
/** "Key takeaways" list: leading ◆ semantic-color square */
...
/** SVG figure + caption (overall fade-up entrance; container is a fixed dark panel in both themes, light-mode.md §3.3) */
export function Figure({
  ...
  return (
    <Reveal className="my-10">
      <figure>
        <div className="diagram-frame overflow-x-auto p-3 sm:p-5">
...
/** arXiv badge (external link arxiv.org/abs/…) */
...
/** Paper citation line: mono caption + arXiv badge */
...
/** Definition card: bg-2 rounded panel + 3px left accent bar */
